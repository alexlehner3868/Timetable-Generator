...
priority_queue<CourseOfferings, vector<CourseOfferings>, greater<CourseOfferings>> get_classes() {
    ...
    std::vector<Section> course_three_lecture_sections = course_data.add_course("ECE568H1", 1);
    ...
    std::vector<Section> course_three_tutorial_sections = course_data.add_course("ECE568H1", 2);
    ...
    std::vector<Section> course_three_practical_sections = course_data.add_course("ECE568H1", 3);
